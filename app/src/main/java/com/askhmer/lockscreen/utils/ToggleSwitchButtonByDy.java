...
/**
 * Created by soklundy on 6/11/2016.
 */
public class ToggleSwitchButtonByDy extends View {
    ...
    public ToggleSwitchButtonByDy(Context context) {
        this(context, null);
    }

    public ToggleSwitchButtonByDy(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mOuterRing = new TargetDrawable(res, R.drawable.switch_shape);
